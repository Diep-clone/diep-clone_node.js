  ...
  if (this.objects.length > MAX_OBJ) {
    if (typeof this.nodes[0] === 'undefined') {
      ...
      for (var i = 0; i < this.objects.length; i++) {
        ...
        // console.log("this.nodes["+index+"].insert(objects["+i+"])");
...
Quadtree.prototype.retrieve = function( obj ) {
	var index = this.getIndex( obj ),
      ...
      if (!o.isDead && (obj.team!==o.team || (obj.team===o.team && obj.owner!==o.owner || (obj.owner===o.owner && obj.isOwnCol>0 && o.isOwnCol>0)))) return o;
