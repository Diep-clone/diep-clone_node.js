...
exports.moveUser = function(u,mapSize){ // 유저(탱크)의 움직임
  if (u.moveRotate!=null && !isNaN(u.moveRotate)){
    //* 0.07;
    u.dx+=Math.cos(u.moveRotate) * (Math.pow(0.985,u.level)*0.13/*+stats[8]*0.0035*/)*0.8;
    u.dy+=Math.sin(u.moveRotate) * (Math.pow(0.985,u.level)*0.13/*+stats[8]*0.0035*/)*0.8;
  }
...
exports.isDeadPlayer = function(obj,users){ // 죽었는가?
  ...
  if (obj.health <= 0){
    if (util.findIndex(users,obj.id) > -1){
      users[util.findIndex(users.obj.id)] = null;
